import { capabilities, getCapability, type AgentId, type Capability, type ToolId } from "@dont-waste/catalog";
import { runCommand } from "./runtime.js";
import type { AdapterContext, Command, InstallResult, OperationPlan, ToolAdapter, ToolSelection } from "./types.js";
